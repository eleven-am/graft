...
const file_raft_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"raft.proto\x12\vgraft.proto\x1a\fcommon.proto\"\xe7\x01\n" +
	...
	"\aentries\x18\x05 \x03(\v2\x15.graft.proto.LogEntryR\aentries\x12#\n" +
	...
	"\x04term\x18\x01 \x01(\x03R\x04term\x12!\n" +
	"\fvote_granted\x18\x02 \x01(\bR\vvoteGranted\"\xcf\x01\n" +
	...
	"\x04term\x18\x01 \x01(\x03R\x04term\x12\x18\n" +
	"\asuccess\x18\x02 \x01(\bR\asuccess2\x95\x02\n" +
	"\vRaftService\x12V\n" +
	"\rAppendEntries\x12!.graft.proto.AppendEntriesRequest\x1a\".graft.proto.AppendEntriesResponse\x12P\n" +
	"\vRequestVote\x12\x1f.graft.proto.RequestVoteRequest\x1a .graft.proto.RequestVoteResponse\x12\\\n" +
	"\x0fInstallSnapshot\x12#.graft.proto.InstallSnapshotRequest\x1a$.graft.proto.InstallSnapshotResponseB&Z$github.com/eleven-am/graft/proto/genb\x06proto3"
...
var file_raft_proto_goTypes = []any{
	(*AppendEntriesRequest)(nil),    // 0: graft.proto.AppendEntriesRequest
	(*AppendEntriesResponse)(nil),   // 1: graft.proto.AppendEntriesResponse
	(*RequestVoteRequest)(nil),      // 2: graft.proto.RequestVoteRequest
	(*RequestVoteResponse)(nil),     // 3: graft.proto.RequestVoteResponse
	(*InstallSnapshotRequest)(nil),  // 4: graft.proto.InstallSnapshotRequest
	(*InstallSnapshotResponse)(nil), // 5: graft.proto.InstallSnapshotResponse
	(*LogEntry)(nil),                // 6: graft.proto.LogEntry
}
var file_raft_proto_depIdxs = []int32{
	6, // 0: graft.proto.AppendEntriesRequest.entries:type_name -> graft.proto.LogEntry
	0, // 1: graft.proto.RaftService.AppendEntries:input_type -> graft.proto.AppendEntriesRequest
	2, // 2: graft.proto.RaftService.RequestVote:input_type -> graft.proto.RequestVoteRequest
	4, // 3: graft.proto.RaftService.InstallSnapshot:input_type -> graft.proto.InstallSnapshotRequest
	1, // 4: graft.proto.RaftService.AppendEntries:output_type -> graft.proto.AppendEntriesResponse
	3, // 5: graft.proto.RaftService.RequestVote:output_type -> graft.proto.RequestVoteResponse
	5, // 6: graft.proto.RaftService.InstallSnapshot:output_type -> graft.proto.InstallSnapshotResponse
