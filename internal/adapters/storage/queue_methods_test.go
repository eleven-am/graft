...
func TestStoragePort_NewQueueMethods(t *testing.T) {
	// Test that new queue-optimized methods are available
	mockStorage := mocks.NewMockStoragePort(t)
	
	// Test GetNext method signature
	...
	// Test CountPrefix method signature
	...
	// Test AtomicIncrement method signature
