...
func (_m *MockEventManager) SubscribeToChannel(prefix string) (<-chan ports.StorageEvent, func(), error) {
...
func (_c *MockEventManager_SubscribeToChannel_Call) Return(_a0 <-chan ports.StorageEvent, _a1 func(), _a2 error) *MockEventManager_SubscribeToChannel_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *MockEventManager_SubscribeToChannel_Call) RunAndReturn(run func(string) (<-chan ports.StorageEvent, func(), error)) *MockEventManager_SubscribeToChannel_Call {
	_c.Call.Return(run)
	return _c
}
