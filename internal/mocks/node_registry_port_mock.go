...
func (_m *MockNodeRegistryPort) RegisterNode(node interface{}) error {
	ret := _m.Called(node)
...
func (_c *MockNodeRegistryPort_RegisterNode_Call) Run(run func(node interface{})) *MockNodeRegistryPort_RegisterNode_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockNodeRegistryPort_RegisterNode_Call) RunAndReturn(run func(interface{}) error) *MockNodeRegistryPort_RegisterNode_Call {
	_c.Call.Return(run)
	return _c
}
