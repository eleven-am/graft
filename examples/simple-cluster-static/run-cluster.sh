...
echo "🚀 Starting 3-node Graft cluster with static discovery..."

mkdir -p ./data/node-1 ./data/node-2 ./data/node-3

echo "📦 Building binary..."
go build -o simple-cluster-static main.go
...
./simple-cluster-static > ./data/node-1/output.log 2>&1 &
NODE1_PID=$!
...
./simple-cluster-static > ./data/node-2/output.log 2>&1 &
NODE2_PID=$!
...
./simple-cluster-static > ./data/node-3/output.log 2>&1 &
NODE3_PID=$!
